...
### Data Sources
The analysis is based on a “sample Superstore.csv dataset” containing sales data. The dataset contains the following columns;
...
~~~
![image](https://github.com/user-attachments/assets/03895bfe-f7e0-4c39-96a0-47bb6acee575)
~~~sql
